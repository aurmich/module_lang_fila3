 ...
 *
 * @method static Translation|null first()
 * @method static \Illuminate\Database\Eloquent\Collection<int, Translation> get()
 * @method static Translation create(array $attributes = [])
 * @method static Translation firstOrCreate(array $attributes = [], array $values = [])
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Translation where(string|\Closure $column, mixed $operator = null, mixed $value = null, string $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Translation whereNotNull(string|\Illuminate\Contracts\Database\Query\Expression $columns)
