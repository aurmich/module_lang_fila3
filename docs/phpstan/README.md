...
=======
=======
# Documentazione PHPStan per il Modulo Lang

## Introduzione

Questa cartella contiene la documentazione relativa all'analisi statica del codice effettuata con PHPStan sul modulo Lang.
