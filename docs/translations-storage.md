...
## Best Practice per la Piattaforma
...
## Raccomandazioni
- Per la piattaforma, **PHP è la scelta principale**. JSON solo per casi particolari.
...
1. **Preparazione**
   - Esporta i file PHP/JSON di riferimento da `/var/www/html/<directory progetto>/laravel/lang/en/` o `/lang/en.json`.
