...
=======
Il LangServiceProvider è un componente fondamentale di  che gestisce automaticamente le traduzioni per i componenti Filament senza richiedere l'uso esplicito del metodo `->label()`.
>>>>>>> d5c53f4 (.)
