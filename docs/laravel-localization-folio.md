...
- [FAQ e problemi comuni](/var/www/html/<directory progetto>/laravel/Modules/Lang/docs/translations-faq.md)
- [Guida language switcher](/var/www/html/<directory progetto>/laravel/Modules/Lang/docs/README.md)
